...
void main() {
	...
	float mass = texelFetchBuffer(tboSampler, gl_VertexID).w;
	...
	//color in function of the speed of the particle
	gl_FrontColor = colorCode(length(speed));

	//color in function of the mass of the particle
	//gl_FrontColor = colorCode(mass);
